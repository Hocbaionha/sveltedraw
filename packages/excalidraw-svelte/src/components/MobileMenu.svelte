<script lang="ts">
  // Port of packages/excalidraw/components/MobileMenu.tsx
  //
  ...
  let {
    ...
    /** Actions bar above the toolbar (MobileShapeActions in upstream). */
    ...
    /** Matches upstream SCROLLBAR_WIDTH + SCROLLBAR_MARGIN (12px). */
