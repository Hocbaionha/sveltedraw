<script lang="ts" module>
  // Port of packages/excalidraw/components/canvases/StaticCanvas.tsx
  //
  // Upstream renderer types (RoughCanvas, RenderableElementsMap,
...
>
  ...
  let {
    ...
    appState: State;
    renderConfig: Config;
    /** Injected renderer — Phase 6 wires `renderStaticScene` from upstream.
