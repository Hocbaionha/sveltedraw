<script lang="ts">
  // Port of packages/excalidraw/components/FontPicker/FontPickerList.tsx
  //
  ...
  //  - Text-editor caret preservation (editingTextElement / excalidraw-wysiwyg
  ...
  //    isn't in @sveltedraw/excalidraw deps.
