<script lang="ts" module>
  // Port of packages/excalidraw/components/ImageExportDialog.tsx
  ...
  //   - persisting setting changes via the on*Change callbacks (~5 upstream
  ...
  export type ImageExportDialogProps = {
    ...
    /** Available scales (default mirrors the upstream EXPORT_SCALES). */
