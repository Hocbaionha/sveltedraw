<script lang="ts" module>
  // Port of packages/excalidraw/components/LayerUI.tsx — layout shell.
...
>
  ...
  // If no ambient TUNNELS_KEY is provided by a wrapping Excalidraw root,
        ...
        >
          {#snippet children()}
            <!-- canvas actions: MainMenuTunnel outlet + optional welcome
                 hint. Host supplies content via MainMenuTunnel.In upstream,
