...
const recomputeOrigin = (
  stateAtCropStart: NonDeleted<SveltedrawElement>,
  transformHandle: TransformHandleType,
  width: number,
  height: number,
...
export const getUncroppedImageElement = (
  ...
  if (element.crop) {
    ...
    const uncroppedElement: SveltedrawImageElement = {
      ...element,
...
export const getUncroppedWidthAndHeight = (element: SveltedrawImageElement) => {
  if (element.crop) {
    const width =
