...
import type { FontString, SveltedrawTextElement } from "./types";
 ...
 */
export const detectLineHeight = (textElement: SveltedrawTextElement) => {
  const lineCount = splitIntoLines(textElement.text).length;
  return (textElement.height /
    lineCount /
    textElement.fontSize) as SveltedrawTextElement["lineHeight"];
};
