 ...
 * Usage:
 *   // root Sveltedraw component (provider)
 ...
 * radio-input names and similar IDs scoped to a single Sveltedraw instance.
 * Optional — components fall back to a generated id when not provided.
 */
export const EXCAL_ID_KEY: unique symbol = Symbol("excalId");

// Tunnels (port of packages/engine/context/tunnels.ts)
export {
  Tunnel,
  FallbackCounter,
  TunnelsContext,
...
export { createPersistence, loadPersistedScene } from "./persistence.js";
