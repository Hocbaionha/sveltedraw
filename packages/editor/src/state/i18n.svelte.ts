...
// Minimal i18n rune store. Mirrors the shape of original's
// `packages/engine/i18n.ts` (defaultLang + languages list + t()),
...
//  - No percentages.json gating (original filters by completion
...
// Full original list is larger; add more here as needed.
...
export async function setLanguage(code: string): Promise<void> {
  ...
  const key = `../../../engine/locales/${code}.json`;
