...
export const restoreElement = (
  ...
  switch (element.type) {
    case "text":
      // temp fix: cleanup legacy obsidian attribute else it'll
...
const repairContainerElement = (
  ...
  if (container.boundElements) {
    // copy because we're not cloning on restore, and we don't want to mutate original
 ...
 *
 * See https://github.com/Hocbaionha/sveltedraw/issues/3795
 *
