// Minimal i18n stub. Post-Phase-9 we removed the jotai-backed upstream
// version; the Svelte port has its own at
// `packages/excalidraw-svelte/src/state/i18n.svelte.ts`.
//
// This file exists only to satisfy a handful of TS files still in
// `packages/excalidraw/` (scene/scrollbars.ts, data/index.ts, tests)
...
//    only to pick left-vs-right orientation; RTL support in upstream
