...
export const ExcalidrawActionManagerContext = React.createContext<ActionManager>(
  null!,
);
...
class App extends React.Component<AppProps, AppState> {
  ...
  private renderEmbeddables() { return renderEmbeddablesHelper(this); }
  ...
  private renderFrameNames = () => renderFrameNamesHelper(this);
  ...
  public componentWillUnmount() {
    lifecycleOps.componentWillUnmount(this.engineContext);
  }
  ...
  private removeEventListeners() {
    lifecycleOps.removeEventListeners(this.engineContext);
  }

  private addEventListeners() {
    lifecycleOps.addEventListeners(this.engineContext);
  }

  componentDidUpdate(prevProps: AppProps, prevState: AppState) {
    return lifecycleOps.componentDidUpdate(
      this.engineContext,
      prevProps,
      prevState,
    );
